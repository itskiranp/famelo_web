    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                Mohamedsabil83\FilamentFormsTinyeditor\Components\TinyEditor::make('data_link')
                    ->columnSpan(span: 'full'),
                Mohamedsabil83\FilamentFormsTinyeditor\Components\TinyEditor::make('codebook_link')
                    ->columnSpan(span: 'full'),
                Mohamedsabil83\FilamentFormsTinyeditor\Components\TinyEditor::make('questions_link')
                    ->columnSpan(span: 'full'),
            ]);
    }
